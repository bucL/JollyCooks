...
//  This file allows us to decode the DeviceModels json file and the variables at thje top allow us to find the bundle information of the app the user is using
